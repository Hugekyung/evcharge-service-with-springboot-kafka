...
| A6 | worktree inventory | Read-only worktree status captured before QA; product changes were preserved. | `.omo/evidence/task-04-domain-implementation/f3-manual-qa.md` |
